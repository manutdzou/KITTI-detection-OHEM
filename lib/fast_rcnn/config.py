...
#__C.TRAIN.SCALES = (370,300,250,500,400)
__C.TRAIN.SCALES = (370,)


# Max pixel size of the longest side of a scaled input image
__C.TRAIN.MAX_SIZE = 1250
...
__C.PIXEL_MEANS = np.array([[[130.9801, 130.9465, 130.7717]]])
