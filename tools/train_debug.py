...
def parse_args():
    ...
    parser.add_argument('--weights', dest='pretrained_model',
                        ...
                        default='/home/bsl/KITTI-detection/data/imagenet_models/VGG_CNN_M_1024.v2.caffemodel', type=str)
    parser.add_argument('--cfg', dest='cfg_file',
                        help='optional config file',
                        default='/home/bsl/KITTI-detection/experiments/cfgs/faster_rcnn_alt_opt.yml', type=str)
    parser.add_argument('--imdb', dest='imdb_name',
                        help='dataset to train on',
                        default='KakouTrain', type=str)
