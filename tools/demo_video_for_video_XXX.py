...
def demo(net, im):
    ...
    for cls_ind, cls in enumerate(CLASSES[1:]):
        ...
        for i in inds:
            ...
            elif cls_ind==3:from fcolor
                cv2.rectangle(im, rect_start, rect_end, color0, 2)
            #elif cls_ind==4:
            #    cv2.rectangle(im, rect_start, rect_end, (100, 100, 100), 2)
            #elif cls_ind==5:
            #    cv2.rectangle(im, rect_start, rect_end, (255, 100, 80), 2)
            #elif cls_ind==6:
            #    cv2.rectangle(im, rect_start, rect_end, (100, 255, 30), 2)
            #elif cls_ind==7:
            #    cv2.rectangle(im, rect_start, rect_end, (200, 80, 90), 2)
            #elif cls_ind==8:
            #   cv2.rectangle(im, rect_start, rect_end, (100, 10, 30), 2)
...
if __name__ == '__main__':
    ...
    dir_root=os.path.join(cfg.ROOT_DIR, 'data',dir_name)
